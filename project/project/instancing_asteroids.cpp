...
int main()
{
	...
	Shader planetShader("instancing_planet.vs", "instancing_planet.frag");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		for (GLuint i = 0; i < amount; i++)
		{
			glUniformMatrix4fv(glGetUniformLocation(planetShader.Program, "model"), 1, GL_FALSE, glm::value_ptr(modelMatrices[i]));
