...
int main()
{
	...
	Shader shader("depth_testing.vs", "blending_sorted.frag");
...
#pragma region "object_initialization"
	...
	// Load textures
	GLuint cubeTexture = loadTexture("depth_cube_tex.jpg");
	GLuint floorTexture = loadTexture("depth_floor_tex.jpg");
	GLuint transparentTexture = loadTexture("blending_transparent_window.png", true);
#pragma endregion
	...
	glm::mat4 testModel;
	testModel = glm::rotate(testModel, glm::radians(45.0f), glm::vec3(1.0, 0, 0));
	//testModel = glm::translate(testModel, glm::vec3(1.0f, 2.0f, 3.0f));
	for (int row = 0; row < 4; row++) {
		for (int column = 0; column < 4; column++) {
			std::cout << testModel[column][row] << " ";
		}
		std::cout << std::endl;
	}
	glm::mat4 transposedModel = glm::transpose(testModel);
	for (int row = 0; row < 4; row++) {
		for (int column = 0; column < 4; column++) {
			std::cout << transposedModel[row][column] << " ";
		}
		std::cout << std::endl;
	}
